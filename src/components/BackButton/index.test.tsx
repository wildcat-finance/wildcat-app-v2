...
jest.mock("@/assets/icons/backArrow_icon.svg", () => ({ __esModule: true, default: () => null }))
jest.mock("@/assets/icons/borrowAndRepay_icon.svg", () => ({ __esModule: true, default: () => null }))
jest.mock("@/assets/icons/lenderBorrower_icon.svg", () => ({ __esModule: true, default: () => null }))
jest.mock("@/assets/icons/marketEvents_icon.svg", () => ({ __esModule: true, default: () => null }))
jest.mock("@/assets/icons/statusAndDetails_icon.svg", () => ({ __esModule: true, default: () => null }))
jest.mock("@/assets/icons/summary_icon.svg", () => ({ __esModule: true, default: () => null }))
jest.mock("@/assets/icons/tokenWrap_icon.svg", () => ({ __esModule: true, default: () => null }))
jest.mock("@/assets/icons/withdrawalAndRequests_icon.svg", () => ({ __esModule: true, default: () => null }))
...
describe("BackButton", () => {
  it("gives the lender market sidebar a link to the markets page", () => {
    ...
    const control = screen.getByRole("link", { name: /Back To Markets/i })
