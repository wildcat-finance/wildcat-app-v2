...
export const ExtendedSelect = forwardRef(
  (
    { label, options, small, selectSX, optionSX, ...rest }: ExtendedSelectProps,
      ...
      case false: {
        return (
          <FormControl>
            ...
            <Select sx={selectSX} {...rest} ref={ref}>
              {options.map((option) => (
        ...
        return (
          <Box>
            <FormControl sx={FormControlContainer}>
              ...
              <Select size="small" sx={selectSX} {...rest} ref={ref}>
                {options.map((option) => (
                  <MenuItem key={option.id} value={option.value} sx={optionSX}>
