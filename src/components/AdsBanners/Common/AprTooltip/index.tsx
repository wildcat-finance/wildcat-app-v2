  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Typography variant="text3" fontWeight={600}>
            {t("marketDetails.shared.aprTooltip.baseApr")}
          </Typography>
        ...
        <Typography variant="text3" color={COLORS.blackRock}>
          {t("marketDetails.shared.aprTooltip.baseAprDescription")}
        </Typography>
      </Box>
        ...
        >
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: "2px" }}>
            <Typography variant="text3" color={COLORS.ultramarineBlue}>
              {t("marketDetails.shared.aprTooltip.withdrawalAnytime.title")}
            </Typography>

            <Typography variant="text4" color={COLORS.ultramarineBlue}>
              {t("marketDetails.shared.aprTooltip.withdrawalAnytime.subtitle")}
            </Typography>
          </Box>
        </Box>
      )}
      ...
      >
        ...
        <Typography variant="text3" color={COLORS.blackRock}>
          {t("marketDetails.shared.aprTooltip.rewardsDescription")}
        </Typography>
      </Box>
      ...
      >
        {t("marketDetails.shared.aprTooltip.disclaimer")}
      </Typography>
    </Paper>
  )
}
