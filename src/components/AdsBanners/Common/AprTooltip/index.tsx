    ...
    >
      ...
      >
        ...
        <Typography variant="text3" color={COLORS.blackRock}>
          {t("marketDetails.shared.banners.apr.baseAprSuffix")}
        </Typography>
      </Box>
        ...
        >
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: "2px" }}>
            <Typography variant="text3" color={COLORS.ultramarineBlue}>
              {t("marketDetails.shared.banners.apr.withdrawAnyTime")}
            </Typography>

            <Typography variant="text4" color={COLORS.ultramarineBlue}>
              {t("marketDetails.shared.banners.apr.withdrawCycleNote")}
            </Typography>
          </Box>
        </Box>
      )}
      ...
      >
        ...
        <Typography variant="text3" color={COLORS.blackRock}>
          {t("marketDetails.shared.banners.apr.incentivesSuffix")}
        </Typography>
      </Box>
      ...
      >
        {t("marketDetails.shared.banners.apr.incentivesDisclaimer")}
      </Typography>
    </Paper>
  )
}
