...
import Phantom from "@/assets/icons/phantom_icon.svg"
...
import { ConnectWalletDialogProps } from "./type"
  ...
  return (
    <Dialog open={open} onClose={handleClose} sx={DialogContainer}>
      ...
      <Typography variant="text3" sx={Terms}>
        {t("mobile.connectWallet.consentPrefix")}{" "}
        <MuiLink
          component={Link}
          ...
          color="inherit"
        >
          {t("mobile.connectWallet.privacyPolicy")}
        </MuiLink>
        .
      </Typography>
    </Dialog>
