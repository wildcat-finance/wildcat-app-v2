  ...
  return (
    <Box sx={CardContainer}>
      ...
      <Box sx={MainInfoContainer}>
        ...
        >
          ...
          <Typography variant="mobText4" color={COLORS.manate}>
            {t("marketList.shared.cards.availableToLend")}
          </Typography>
        </Box>
      </Box>
      ...
      <Box sx={AprWithdrawalContainer}>
        ...
        <Box sx={AprWithdrawalItemContainer}>
          <Typography variant="mobText4">
            {t("marketList.shared.tables.header.withdrawal")}
          </Typography>
      ...
      <Box sx={CardFooterContainer}>
        ...
        >
          {t("marketList.shared.cards.assetDeposited", {
            amount: getDepositLine(),
        ...
        <Box sx={CardFooterButtonsContainer}>
          ...
          >
            ...
            >
              {t("marketList.shared.cards.more")}
            </Button>
          </Link>
          {buttonText && (
            <Link
