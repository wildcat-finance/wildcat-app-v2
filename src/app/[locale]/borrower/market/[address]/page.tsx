  ...
  if (
    ...
    return (
      <Box sx={{ padding: "52px 20px 0 44px" }}>
        <Box sx={{ width: "69%" }}>
          <LeadBanner
            title={t("marketDetails.borrower.selectMlaSettings")}
            subtitle={t(
              "marketDetails.borrower.mlaSelectionWasNotSuccessfully",
            )}
            buttonText={t("marketDetails.borrower.goMlaSettings")}
