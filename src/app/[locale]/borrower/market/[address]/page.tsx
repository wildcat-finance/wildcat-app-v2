      ...
      <Box sx={{ padding: "52px 20px 0 44px" }}>
        <Box sx={{ width: "69%" }}>
          <Typography variant="title2">
            {t("marketDetails.borrower.notFound")}
          </Typography>
        </Box>
      </Box>
    )
  ...
  if (
    ...
    return (
      <Box sx={{ padding: "52px 20px 0 44px" }}>
        <Box sx={{ width: "69%" }}>
          <LeadBanner
            title={t("marketDetails.borrower.modals.selectMlaSettings.title")}
            text={t("marketDetails.borrower.modals.selectMlaSettings.text")}
            buttonText={t(
              "marketDetails.borrower.modals.selectMlaSettings.buttonText",
            )}
