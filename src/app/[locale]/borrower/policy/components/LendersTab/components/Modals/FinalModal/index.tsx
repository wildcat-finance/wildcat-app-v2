        ...
        <>
          ...
          <Box padding="24px" sx={DeployContentContainer}>
            <Box margin="auto" sx={DeployMainContainer}>
              ...
              <Box sx={DeployTypoBox}>
                ...
                <Typography variant="text3" sx={DeploySubtitle}>
                  {t("borrower.policy.modals.final.error.subtitle")}
                </Typography>
              </Box>
            </Box>
            ...
            <Box sx={DeployButtonContainer}>
              ...
              >
                {t("borrower.policy.modals.final.error.tryAgain")}
              </Button>
            </Box>
          </Box>
        </>
      ...
      {showSuccessPopup && (
        <Box padding="24px" sx={DeployContentContainer}>
          ...
          >
            ...
            <Box sx={DeployTypoBox}>
              <Typography variant="title3">
                {t("borrower.policy.modals.final.success.title")}
              </Typography>
              <Typography variant="text3" sx={DeploySubtitle}>
                {t("borrower.policy.modals.final.success.subtitle")}
              </Typography>
            </Box>
          </Box>
        </Box>
        ...
        <Box sx={DeployContentContainer} rowGap="24px">
          ...
          <Box sx={DeployTypoBox}>
            <Typography variant="text1">
              {t("borrower.policy.modals.final.loading.title")}
            </Typography>
            <Typography variant="text3" sx={DeploySubtitle}>
              {t("borrower.policy.modals.final.loading.subtitle")}
            </Typography>
          </Box>
        </Box>
      )}
