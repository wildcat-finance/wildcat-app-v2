  ...
  const columns: GridColDef[] = [
    {
      sortable: false,
      field: "lender",
      headerName: t("marketDetails.withdrawals.tableColumns.lender"),
      minWidth: 176,
      headerAlign: "left",
      align: "left",
      renderCell: ({ value }) => (
    ...
    },
    {
      sortable: false,
      field: "dateSubmitted",
      headerName: t("marketDetails.withdrawals.tableColumns.date"),
      minWidth: 216,
      headerAlign: "left",
      align: "left",
    },
    {
      sortable: false,
      field: "transactionId",
      headerName: t("marketDetails.withdrawals.tableColumns.txID"),
      minWidth: 216,
      headerAlign: "left",
      align: "left",
      renderCell: ({ value }) => (
    ...
    },
    {
      sortable: false,
      field: "amount",
      headerName: t("marketDetails.withdrawals.tableColumns.amount"),
      minWidth: 120,
      flex: 1,
      headerAlign: "right",
      align: "right",
