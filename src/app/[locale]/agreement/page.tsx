      ...
      >
        ...
        >
          <Typography variant="text2">
            This Wildcat Protocol Services Agreement (this ’Agreement’) sets out
            the terms and conditions under you access the Wildcat Protocol (the
            ’Protocol’) and accept the Services (as defined below) that the
            Service Provider (also referred to as ’us’; or ’we’) will provide in
          ...
          <Typography variant="text2">
            ...
            suffer loss, you should not enter into transactions on, or otherwise
            use, the Protocol. Before transacting, you must carefully assess and
            consider the risks, including those contained in any documents we
            make available to you and obtain all necessary professional advice
            you need.
          </Typography>
          ...
          <Typography variant="text2">
            ...
            provide any warnings to you. You must carefully consider and monitor
            your own transactions and in particular any loans you have made or
            taken out. We are not party to these transactions and therefore
            assume no obligation to monitor the same.
          </Typography>
          ...
          <Typography variant="text2">
            This Agreement, including its Schedules, must be read in the context
            of any applicable Risk Disclosure Statement made available to you.
          </Typography>
          ...
          <Typography variant="text2">
            ...
            control with such party; for which purposes ’control’ shall mean the
            ability to direct the management or policies of a company or legal
            entity: (a) through beneficial ownership of fifty percent (50%) or
            more of the voting shares or other securities of a company or legal
            entity; (b) in the position as general partner of a limited
            partnership or manager of a limited liability company; or (c)
            pursuant to a written agreement.
          </Typography>

          <Typography variant="text2">
            AGREEMENT means this Wildcat Protocol Services Agreement as the same
            may be amended, restated or otherwise modified from time to time at
          ...
          <Typography variant="text2">
            ASSETS means any assets that a Borrower may borrow or try to borrow
            from a Lender;
          </Typography>
          ...
          <Typography variant="text2">
            ...
            including, without limitation, technical data and know-how relating
            to the business of such Borrower or Lender or any of its suppliers,
            customers, agents, distributors, shareholders, management or
            business contacts and including, but not limited to, information
            that the Service Provider creates, develops, receives or obtains in
            connection with this Agreement whether or not such information (if
            in anything other than oral form) is marked confidential;
          </Typography>
          ...
          <Typography variant="text2">
            ...
            drugs, humans or wildlife, slavery, proliferation of weapons of mass
            destruction, or evasion of sanctions. A reference to a violation of
            Financial Crime Regulation includes any acts or attempts to
            circumvent or violate any applicable laws relating to Financial
            Crime Regulation;
          </Typography>
          ...
          <Typography variant="text2">
            ...
            otherwise modified from time to time and includes any document which
            amends, restates, supplements, replaces, or otherwise modifies or is
            entered into, made or given pursuant to or in accordance with any of
            the terms of this Agreement or, as the case may be, the relevant
          ...
          <Typography variant="text2">
            ...
            terms and conditions of this Agreement and hereby acknowledges that
            the Service Provider shall provide the Services on the terms of this
            Agreement.
          </Typography>
          ...
          <Typography variant="text2">
            ...
            operation of the Protocol ceasing to be feasible or (b) would cause
            the Service Provider to operate in an improper or illegal manner, in
            each case as determined by the Service Provider in its sole
            discretion; or
          </Typography>
          ...
          <Typography variant="text2">
            (iv) except for the security monitoring responsibilities as provided
            in the Schedule hereto, have any obligation to provide ongoing
            security for the Borrowers, the Lenders and the Protocol; and
          </Typography>

          <Typography variant="text2">
            (v) except as provided in the Schedule hereto, have any obligations
            in the event of a market delinquency.
          </Typography>
          ...
          <Typography variant="text2">
            ...
            entitled to receive a fee pursuant to the protocol fee configuration
            under which the relevant market is deployed (the ’Fee’).
          </Typography>
          <Typography variant="text2">
            ...
            the case of a Fee that is represented as a proportion of base annual
            percentage return, the designated fee recipient address becomes
            inaccessible; provided however, that notwithstanding the foregoing,
            no Fee shall be retroactively revised once a market has been
            deployed under a protocol fee configuration.
          </Typography>
          ...
          <Typography variant="text2">
            (b) The Representing Party has made its own independent decision to
          ...
          <Typography variant="text2">
            ...
            Party, and has not advised the Representing Party in connection with
            this Agreement.
          </Typography>
          ...
          <Typography variant="text2">
            ...
            as advice, recommendation or guarantee of result in connection with
            this Agreement.
          </Typography>
          ...
          <Typography variant="text2">
            (a) The Representing Party is capable of assessing and understanding
          ...
          <Typography variant="text2">
            (b) The Representing Party is capable of assuming, and assumes, all
            risks associated with this Agreement.
          </Typography>
          ...
          <Typography variant="text2">
            ...
            Party to the Service Provider or the Protocol is, as of the date of
          ...
          <Typography variant="text2">
            ...
            its obligations hereunder, (b) it has taken all necessary action to
            authorize such execution, delivery and performance, and (iii) this
          ...
          <Typography variant="text2">
            (ii) any information which is already in, or comes into, the public
            domain otherwise than through the Service Provider’s unauthorised
            disclosure.
          </Typography>
          ...
          <Typography variant="text2">
            ...
            or relating to this Agreement or the Protocol, whether for breach of
            ...
            Borrowers or the Lenders have been advised of the possibility of any
            such Loss, unless such Loss arises directly from the Service
            Provider’s or its Affiliates’ wilful default, gross negligence or
            actual fraud.
          </Typography>
          ...
          <Typography variant="text2">
            (a) This Clause 7.2 is without prejudice to the generality of Clause
            7.1.
          </Typography>

          <Typography variant="text2">
            (b) The Service Provider will not be liable to any Borrower or any
            Lender for any Loss arising from any failure, interruption or delay
            in performance of any obligation arising under this Agreement
            resulting from acts or events not reasonably within the Service
            Provider’s control including without limitation, acts of war and
            terrorism, insurrection, civil disorder, acts of God, industrial
            action, any acts or regulations of any Government Agency, or any
            other operational or technical failures.
          </Typography>

          <Typography variant="text2">
            (c) The Service Provider will not be liable for any Loss, liability,
            cost or expense whatsoever arising from unauthorised use of the
            Protocol. Each Borrower and each Lender will, on demand, indemnify,
            protect and hold the Service Provider harmless from and against all
            ...
            omission by any person using the Protocol or accessing the Service
            Provider’s services through use of a Borrower&#39;s or a Lender’s
            designated passwords, systems and devices, whether or not such
            Borrower or such Lender has authorised such use.
          </Typography>
          ...
          <Typography variant="text2">
            ...
            costs, claims, damages or expenses incurred by the Service Provider
            arising during the course of the Service Provider providing the
            Services save for costs, claims, damages or expenses arising due to
            the Service Provider’s actual fraud, gross negligence or wilful
            default.
          </Typography>
          ...
          <Typography variant="text2">
            ...
            respect of a Borrower or Lender as the case may be if at any time a
            Borrower or Lender (each of the following a ’Termination Event’):
          </Typography>
          ...
          <Typography variant="text2">
            (ii) commits any serious or repeated breach or non-observance of any
          ...
          <Typography variant="text2">
            (iv) commits any fraud or dishonesty or acts in any manner which in
            the opinion of the Borrowers and the Lenders brings or is likely to
            bring the Service Provider or the Borrowers or the Lenders into
            disrepute or is materially adverse to the interests of the Borrowers
            or the Lenders;
          </Typography>
          ...
          <Typography variant="text2">
            ...
            prejudice to any other rights that they may have at law to terminate
            the Agreement or to accept any breach of this Agreement on the part
            of a Borrower or Lender as having brought the Agreement to an end.
            Any delay by the Service Provider in exercising its rights to
          ...
          <Typography variant="text2">
            ...
            a breach of any Financial Crime Regulation.
          </Typography>
          ...
          <Typography variant="text2">
            ...
            information concerning any Borrower or any Lender to any Government
            Agency or court (in any jurisdiction), where required by applicable
            law.
          </Typography>
          ...
          <Typography variant="text2">
            ...
            Affiliates of any information or data in connection with or relating
            to such Borrower or such Lender and/or this Agreement, to the extent
            that the Service Provider determines it is required, permitted or
            desirable to:
          </Typography>
          ...
          <Typography variant="text2">
            ...
            contrary, the Service Provider is not obliged to do or omit to do
            anything if it would, or might in its reasonable opinion, constitute
            a breach of any Financial Crime Regulation or any anti-money
            laundering, counter-terrorism financing or economic or trade
            sanctions laws (“AML/CTF Provisions”) applicable to the Service
            Provider.
          </Typography>

          <Typography variant="text2">
            (b) Each Borrower and each Lender must provide to the Service
            Provider upon request all information and documents that are within
            its possession, custody or control reasonably required by the
            Service Provider from time to time, and as necessary in order for
            the Service Provider to comply with any AML/CTF Provisions or
          ...
          <Typography variant="text2">
            ...
            may disclose any information concerning such Borrower or such Lender
            to any Government Agency or court (in any jurisdiction) where
            required by applicable law.
          </Typography>
          ...
          <Typography variant="text2">
            ...
            unenforceable in any respect, in whole or in part, under any law of
            any jurisdiction, neither the legality, validity and enforceability
            in that jurisdiction of any other provision or part of this
            Agreement, nor the legality, validity or enforceability in any other
            jurisdiction of that provision or part or of any other provision of
            this Agreement, shall be affected or impaired.
          </Typography>
          ...
          <Typography variant="text2">
            ...
            electronically. Without limitation to the generality of this Clause
            16, the parties agree that either DocuSign (and similar services) or
            various cryptographic message signing techniques (such as the ECDSA
            signing algorithm) may be used to execute and deliver this
            Agreement.
          </Typography>
          ...
          <Typography variant="text2">
            (c) Any notice or communication that is digitally signed must comply
          ...
          <Typography variant="text2">
            ...
            relating to this Agreement shall be settled by arbitration pursuant
            to the BVI IAC Arbitration Rules.
          </Typography>
          ...
          <Typography variant="text2">
            Notwithstanding any other provision of this Agreement, including for
            the avoidance of doubt Clause 17.1, each Borrower and each Lender
            agrees that the Service Provider has the right to apply for
          ...
          <Typography variant="text2">
            ...
            liabilities arising out of it or in connection with it) is governed
            by and is to be construed in accordance with the laws of the British
            Virgin Islands.
          </Typography>
          ...
          <Typography variant="text2">
            ● Market delinquency monitoring, including monitoring reserve ratios
            for each market to ensure such markets do not go below the reserve
            ratio and become delinquent.
          </Typography>
          ...
          <Typography variant="text2">
            ...
            updating of code that the Service Provider (in its sole discretion)
