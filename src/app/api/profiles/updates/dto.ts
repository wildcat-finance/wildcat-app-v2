...
export const BorrowerProfileInputDTO = z.object({
  ...
  website: z.string().min(0).max(64).optional(),
  twitter: z.string().min(0).max(64).optional(),
  linkedin: z.string().min(0).max(64).optional(),
  email: z.string().min(0).max(64).optional(),
