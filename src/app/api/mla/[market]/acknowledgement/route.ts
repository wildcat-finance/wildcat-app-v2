import { isSupportedChainId, wildcatMarketAbi } from "@wildcatfi/wildcat-sdk"
...
export async function POST(
  ...
  const publicClient = getViemPublicClientForServer(chainId)
  let marketName: string
  try {
    marketName = await publicClient.readContract({
